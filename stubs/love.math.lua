...
function love.colorFromBytes(rb, gb, bb, ab) end
...
function love.colorToBytes(r, g, b, a) end
...
function love.gammaToLinear(r, g, b) end
...
function love.getRandomSeed() end
...
function love.getRandomState() end
...
function love.isConvex(vertices) end
...
function love.linearToGamma(lr, lg, lb) end
...
---@param seed number
function love.setRandomSeed(seed) end
...
---@param state string
function love.setRandomState(state) end
...
function love.triangulate(polygon) end
