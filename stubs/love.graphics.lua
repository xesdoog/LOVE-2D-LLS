...
function love.graphics.Canvas() end

--- Superclass for all things that can be drawn on screen. This is an abstract type that can't be created directly.
function love.graphics.Drawable() end

--- Defines the shape of characters that can be drawn onto the screen.
function love.graphics.Font() end

--- Drawable image type.
function love.graphics.Image() end

--- A 2D polygon mesh used for drawing arbitrary textured shapes.
function love.graphics.Mesh() end
...
function love.graphics.ParticleSystem() end
...
function love.graphics.Shader() end
...
function love.graphics.SpriteBatch() end

--- Drawable text.
function love.graphics.Text() end
...
function love.graphics.Texture() end

--- A drawable video.
function love.graphics.Video() end
