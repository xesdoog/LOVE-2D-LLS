...
function love.getKerning(leftchar, rightchar) end
...
function love.getWidth(text) end
...
function love.getWrap(text, wraplimit) end
...
function love.hasGlyphs(text) end
...
---@param ... Font
function love.setFallbacks(fallbackfont1, ...) end
...
---@param height number
function love.setLineHeight(height) end
