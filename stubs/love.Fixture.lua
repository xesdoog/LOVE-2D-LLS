...
function love.getFilterData() end

--- Returns the friction of the fixture.
---@return number friction # The fixture friction.
function love.getFriction() end
...
function love.getRestitution() end
...
function love.rayCast(x1, y1, x2, y2, maxFraction, childIndex) end
...
---@param mask number
---@param group number
function love.setFilterData(categories, mask, group) end
...
function love.setFriction(friction) end
...
---@param group number
function love.setGroupIndex(group) end
...
---@param ... number
function love.setMask(...) end

--- Sets the restitution of the fixture.
---@param restitution number
function love.setRestitution(restitution) end
...
function love.setSensor(sensor) end
...
function love.testPoint(x, y) end
