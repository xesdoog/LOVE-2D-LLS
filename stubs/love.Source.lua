...
function love.getAirAbsorption() end
...
function love.getAttenuationDistances() end
...
function love.getDuration(unit) end
...
function love.getEffect(name, filtersettings) end
...
function love.getFreeBufferCount() end

--- Gets the current pitch of the Source.
---@return number pitch # The pitch, where 1.0 is normal.
function love.getPitch() end
...
function love.queue(sounddata) end

--- Sets the currently playing position of the Source.
---@param offset number
---@param unit? TimeUnit
function love.seek(offset, unit) end
...
---@param amount number
function love.setAirAbsorption(amount) end
...
---@param ref number
---@param max number
function love.setAttenuationDistances(ref, max) end
...
function love.setCone(innerAngle, outerAngle, outerVolume) end

--- Sets the direction vector of the Source. A zero vector makes the source non-directional.
---@param x number
---@param y number
---@param z number
function love.setDirection(x, y, z) end
...
function love.setEffect(name, enable) end

--- Sets a low-pass, high-pass, or band-pass filter to apply when playing the Source.
---@param settings table
---@return boolean success # Whether the filter was successfully applied to the Source.
function love.setFilter(settings) end

--- Sets whether the Source should loop.
---@param loop boolean
function love.setLooping(loop) end

--- Sets the pitch of the Source.
---@param pitch number
function love.setPitch(pitch) end
...
---@param enable? boolean
function love.setRelative(enable) end
...
function love.setRolloff(rolloff) end
...
---@param min number
---@param max number
function love.setVolumeLimits(min, max) end
