...
function love.Transform.apply(other) end

--- Creates a new copy of this Transform.
---@return Transform clone # The copy of this Transform.
function love.Transform.clone() end
...
function love.Transform.getMatrix() end
...
function love.Transform.inverse() end
...
function love.Transform.inverseTransformPoint(localX, localY) end
...
---@param e4_4 number
---@return Transform transform # The Transform object the method was called on. Allows easily chaining Transform methods.
function love.Transform.setMatrix(e1_1, e1_2, e1_3, e1_4, e2_1, e2_2, e2_3, e2_4, e3_1, e3_2, e3_3, e3_4, e4_1, e4_2, e4_3, e4_4) end
...
---@param ky? number
---@return Transform transform # The Transform object the method was called on. Allows easily chaining Transform methods.
function love.Transform.setTransformation(x, y, angle, sx, sy, ox, oy, kx, ky) end
...
---@param ky number
---@return Transform transform # The Transform object the method was called on. Allows easily chaining Transform methods.
function love.Transform.shear(kx, ky) end
...
function love.Transform.transformPoint(globalX, globalY) end
...
---@param dy number
---@return Transform transform # The Transform object the method was called on. Allows easily chaining Transform methods.
function love.Transform.translate(dx, dy) end
