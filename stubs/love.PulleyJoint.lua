...
function love.getGroundAnchors() end

--- Get the current length of the rope segment attached to the first body.
---@return number length # The length of the rope segment.
function love.getLengthA() end

--- Get the current length of the rope segment attached to the second body.
---@return number length # The length of the rope segment.
function love.getLengthB() end
...
---@param max1 number
---@param max2 number
function love.setMaxLengths(max1, max2) end

--- Set the pulley ratio.
---@param ratio number
function love.setRatio(ratio) end
