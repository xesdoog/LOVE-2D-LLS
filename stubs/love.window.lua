...
function love.fromPixels(pixelvalue) end
...
function love.getSafeArea() end

--- Gets the window title.
---@return string title # The current window title.
function love.getTitle() end
...
function love.isDisplaySleepEnabled() end
...
function love.maximize() end

--- Minimizes the window to the system's task bar / dock.
function love.minimize() end
...
function love.setDisplaySleepEnabled(enable) end
...
function love.setFullscreen(fullscreen) end
...
function love.setIcon(imagedata) end
...
function love.showMessageBox(title, message, type, attachtowindow) end
...
function love.toPixels(value) end
...
---@return boolean success # True if successful, false otherwise.
function love.updateMode(width, height, settings) end
