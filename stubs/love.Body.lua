...
function love.Body.applyAngularImpulse(impulse) end
...
---@param ix number
---@param iy number
function love.Body.applyLinearImpulse(ix, iy) end
...
---@param torque number
function love.Body.applyTorque(torque) end
...
function love.Body.getAngularDamping() end
...
function love.Body.getAngularVelocity() end
...
function love.Body.getLinearDamping() end
...
function love.Body.getLinearVelocityFromLocalPoint(x, y) end
...
---@return number vx # The x component of velocity at point (x,y).
---@return number vy # The y component of velocity at point (x,y).
function love.Body.getLinearVelocityFromWorldPoint(x, y) end
...
function love.Body.getLocalCenter() end
...
function love.Body.getLocalPoint(worldX, worldY) end
...
function love.Body.getLocalPoints(x1, y1, x2, y2, ...) end
...
function love.Body.getMassData() end
...
---@return number x # The x coordinate of the center of mass.
---@return number y # The y coordinate of the center of mass.
function love.Body.getWorldCenter() end
...
function love.Body.getWorldPoint(localX, localY) end
...
function love.Body.getWorldPoints(x1, y1, x2, y2) end
...
function love.Body.isAwake() end
...
function love.Body.setActive(active) end
...
---@param angle number
function love.Body.setAngle(angle) end
...
function love.Body.setAngularDamping(damping) end
...
---@param w number
function love.Body.setAngularVelocity(w) end

--- Wakes the body up or puts it to sleep.
---@param awake boolean
function love.Body.setAwake(awake) end
...
function love.Body.setBullet(status) end
...
function love.Body.setFixedRotation(isFixed) end

--- Sets a new gravity scale factor for the body.
---@param scale number
function love.Body.setGravityScale(scale) end

--- Set the inertia of a body.
---@param inertia number
function love.Body.setInertia(inertia) end
...
---@param ld number
function love.Body.setLinearDamping(ld) end
...
---@param x number
---@param y number
function love.Body.setLinearVelocity(x, y) end

--- Sets a new body mass.
---@param mass number
function love.Body.setMass(mass) end
...
---@param mass number
---@param inertia number
function love.Body.setMassData(x, y, mass, inertia) end
...
function love.Body.setSleepingAllowed(allowed) end
