...
---@param name string
---@param mesh any
function love.Mesh.attachAttribute(name, mesh) end
...
function love.Mesh.detachAttribute(name) end
...
function love.Mesh.getVertex(index) end
...
function love.Mesh.getVertexAttribute(vertexindex, attributeindex) end

--- Gets the total number of vertices in the Mesh.
---@return number count # The total number of vertices in the mesh.
function love.Mesh.getVertexCount() end
...
function love.Mesh.getVertexFormat() end
...
function love.Mesh.getVertexMap() end
...
function love.Mesh.isAttributeEnabled(name) end
...
function love.Mesh.setAttributeEnabled(name, enable) end

--- Sets the mode used when drawing the Mesh.
---@param mode any
function love.Mesh.setDrawMode(mode) end

--- Restricts the drawn vertices of the Mesh to a subset of the total.
---@param start number
---@param count number
function love.Mesh.setDrawRange(start, count) end

--- Sets the texture (Image or Canvas) used when drawing the Mesh.
---@param texture any
function love.Mesh.setTexture(texture) end
...
---@param ... number
function love.Mesh.setVertex(index, attributecomponent, ...) end
...
---@param value2 number
---@param ... number
function love.Mesh.setVertexAttribute(vertexindex, attributeindex, value1, value2, ...) end
...
---@param map table
function love.Mesh.setVertexMap(map) end
...
---@param count? number
function love.Mesh.setVertices(vertices, startvertex, count) end
