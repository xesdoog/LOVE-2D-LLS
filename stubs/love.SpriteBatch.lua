...
function love.SpriteBatch.add(x, y, r, sx, sy, ox, oy, kx, ky) end
...
function love.SpriteBatch.addLayer(layerindex, x, y, r, sx, sy, ox, oy, kx, ky) end
...
---@param name string
---@param mesh any
function love.SpriteBatch.attachAttribute(name, mesh) end
...
function love.SpriteBatch.flush() end

--- Gets the maximum number of sprites the SpriteBatch can hold.
---@return number size # The maximum number of sprites the batch can hold.
function love.SpriteBatch.getBufferSize() end
...
function love.SpriteBatch.getTexture() end
...
---@param kx? number
---@param ky? number
function love.SpriteBatch.set(spriteindex, x, y, r, sx, sy, ox, oy, kx, ky) end
...
---@param b number
---@param a? number
function love.SpriteBatch.setColor(r, g, b, a) end

--- Restricts the drawn sprites in the SpriteBatch to a subset of the total.
---@param start number
---@param count number
function love.SpriteBatch.setDrawRange(start, count) end
...
---@param kx? number
---@param ky? number
function love.SpriteBatch.setLayer(spriteindex, layerindex, x, y, r, sx, sy, ox, oy, kx, ky) end

--- Sets the texture (Image or Canvas) used for the sprites in the batch, when drawing.
---@param texture any
function love.SpriteBatch.setTexture(texture) end
