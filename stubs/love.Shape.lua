...
function love.Shape.computeAABB(tx, ty, tr, childIndex) end
...
function love.Shape.computeMass(density) end

--- Returns the number of children the shape has.
---@return number count # The number of children.
function love.Shape.getChildCount() end

--- Gets the radius of the shape.
---@return number radius # The radius of the shape.
function love.Shape.getRadius() end
...
function love.Shape.getType() end
...
function love.Shape.rayCast(x1, y1, x2, y2, maxFraction, tx, ty, tr, childIndex) end
...
function love.Shape.testPoint(tx, ty, tr, x, y) end
