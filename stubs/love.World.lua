...
function love.World.getCallbacks() end

--- Returns the number of contacts in the world.
---@return number n # The number of contacts in the world.
function love.World.getContactCount() end
...
function love.World.isDestroyed() end
...
function love.World.isLocked() end
...
function love.World.isSleepingAllowed() end
...
function love.World.queryBoundingBox(topLeftX, topLeftY, bottomRightX, bottomRightY, callback) end
...
---@param y2 number
---@param callback function
function love.World.rayCast(x1, y1, x2, y2, callback) end
...
function love.World.setCallbacks(beginContact, endContact, preSolve, postSolve) end
...
function love.World.setContactFilter(filter) end

--- Set the gravity of the world.
---@param x number
---@param y number
function love.World.setGravity(x, y) end

--- Sets the sleep behaviour of the world.
---@param allow boolean
function love.World.setSleepingAllowed(allow) end
...
---@param x number
---@param y number
function love.World.translateOrigin(x, y) end

--- Update the state of the world.
---@param dt number
---@param velocityiterations? number
---@param positioniterations? number
function love.World.update(dt, velocityiterations, positioniterations) end
