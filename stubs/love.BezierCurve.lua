...
function love.BezierCurve.evaluate(t) end
...
function love.BezierCurve.getControlPoint(i) end

--- Get the number of control points in the Bézier curve.
---@return number count # The number of control points.
function love.BezierCurve.getControlPointCount() end
...
function love.BezierCurve.getDegree() end
...
function love.BezierCurve.getDerivative() end
...
function love.BezierCurve.getSegment(startpoint, endpoint) end
...
---@param y number
---@param i? number
function love.BezierCurve.insertControlPoint(x, y, i) end

--- Removes the specified control point.
---@param index number
function love.BezierCurve.removeControlPoint(index) end
...
function love.BezierCurve.render(depth) end
...
function love.BezierCurve.renderSegment(startpoint, endpoint, depth) end

--- Rotate the Bézier curve by an angle.
---@param angle number
---@param ox? number
---@param oy? number
function love.BezierCurve.rotate(angle, ox, oy) end

--- Scale the Bézier curve by a factor.
---@param s number
---@param ox? number
---@param oy? number
function love.BezierCurve.scale(s, ox, oy) end

--- Set coordinates of the i-th control point. Indices start with 1.
---@param i number
---@param x number
---@param y number
function love.BezierCurve.setControlPoint(i, x, y) end

--- Move the Bézier curve by an offset.
---@param dx number
---@param dy number
function love.BezierCurve.translate(dx, dy) end
