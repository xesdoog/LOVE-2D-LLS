...
function love.ChainShape.getChildEdge(index) end
...
function love.ChainShape.getPoints() end
...
function love.ChainShape.getPreviousVertex() end

--- Returns the number of vertices the shape has.
---@return number count # The number of vertices.
function love.ChainShape.getVertexCount() end
...
---@param x number
---@param y number
function love.ChainShape.setNextVertex(x, y) end
...
---@param x number
---@param y number
function love.ChainShape.setPreviousVertex(x, y) end
