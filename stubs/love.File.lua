...
function love.setBuffer(mode, size) end
...
---@return boolean success # Whether the operation was successful.
---@return string err # The error string if an error occurred.
function love.write(data, size) end
