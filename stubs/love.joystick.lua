...
function love.getDeviceInfo() end
...
---@return number direction # Current value of the axis.
function love.getGamepadAxis(axis) end
...
function love.getGamepadMapping(axis) end
...
function love.getID() end

--- Gets the name of the joystick.
---@return string name # The name of the joystick.
function love.getName() end
...
function love.isDown(buttonN) end
...
function love.setVibration(left, right) end
