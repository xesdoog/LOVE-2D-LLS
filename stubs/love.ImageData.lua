...
function love.ImageData.encode(format, filename) end
...
function love.ImageData.getDimensions() end

--- Gets the height of the ImageData in pixels.
---@return number height # The height of the ImageData in pixels.
function love.ImageData.getHeight() end
...
function love.ImageData.getPixel(x, y) end

--- Gets the width of the ImageData in pixels.
---@return number width # The width of the ImageData in pixels.
function love.ImageData.getWidth() end
...
---@param width? number
---@param height? number
function love.ImageData.mapPixel(pixelFunction, x, y, width, height) end
...
---@param sw number
---@param sh number
function love.ImageData.paste(source, dx, dy, sx, sy, sw, sh) end
