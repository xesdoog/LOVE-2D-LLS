...
function love.getDepthSampleMode() end
...
function love.getLayerCount() end
...
function love.getMipmapFilter() end
...
function love.getTextureType() end
...
---@param compare CompareMode
function love.setDepthSampleMode(compare) end

--- Sets the filter mode of the Texture.
---@param min FilterMode
---@param mag? FilterMode
---@param anisotropy? number
function love.setFilter(min, mag, anisotropy) end
...
function love.setMipmapFilter(filtermode, sharpness) end
...
---@param horiz WrapMode
---@param vert? WrapMode
---@param depth? WrapMode
function love.setWrap(horiz, vert, depth) end
